...
filename = 'PID_pinolo.txt'; 
fileID = fopen(filename, 'r');

% Usa textscan per leggere tutto il file correttamente
data = textscan(fileID, '%s %f %f %f %f %f %f %f %f %f %f %f %s %f %f %s %f', ...
...
grid on;
plot(x, rpm_actual, '-b', 'DisplayName', 'RPM');
hold on;
